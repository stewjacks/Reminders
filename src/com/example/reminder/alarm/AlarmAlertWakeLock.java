...
public class AlarmAlertWakeLock {
    ...
    public static PowerManager.WakeLock createPartialWakeLock(Context context) {
        ...
        return pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, Constants.APP_NAME);
    }
    ...
    public static void acquireScreenCpuWakeLock(Context context) {
        ...
        sCpuWakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK
                | PowerManager.ACQUIRE_CAUSES_WAKEUP | PowerManager.ON_AFTER_RELEASE, Constants.APP_NAME);
        sCpuWakeLock.acquire();
    }
